...
Assuming steady state by the time a snow flake reaches the height of the wind turbine, its horizontal component of velocity would equal that of the wind velocity w. =>
d = (w/g)&radic; 2gz
